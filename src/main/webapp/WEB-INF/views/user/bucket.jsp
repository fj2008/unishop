...
<%@ include file="../layout/header.jsp"%>
 ...
 <main>
                ...
                <div class="info-align">
                  ...
                  <td>
                    <div class="info-align-box">
                        ...
                        <!-- 여기에 수량 박스 추가 -->
                        <div>
                          <input class="num-wrap" value="1" readonly>
                        </div>
                        
                        <div class="up-and-down">
                          <input type="image" id="up" src="https://img.icons8.com/material-outlined/24/000000/up.png"/>
                          <input type="image" id="down" img src="https://img.icons8.com/material-outlined/24/000000/down--v1.png"/>
                        </div>
                ...
                <div class="info-align">
                  ...
                  <td>
                    <div class="info-align-box">
                        ...
                        <!-- 여기에 수량 박스 추가 -->
                        <div>
                          <input class="num-wrap" value="${count}" readonly>
                        </div>
                        
                        <div class="up-and-down">
                          <input type="image" src="https://img.icons8.com/material-outlined/24/000000/up.png"/>
                          <input type="image" src="https://img.icons8.com/material-outlined/24/000000/down--v1.png"/>
                        </div>
                  ...
                  <td>
                    <div class="info-align-box">
                      <div>
                        <input class="all-count" value="${bucketsum}" readonly>
                      </div>
    ...
    <script>
      function solve() {
        let st = document.querySelector("post.price");
        st.addEventListener("price", "solve");
      }
